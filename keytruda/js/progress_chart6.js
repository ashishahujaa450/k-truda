...
Dial.prototype.createDefs = function() {
    ...
    linearGradient.setAttribute('id', 'gradient5');
    ...
    linearGradientBackground.setAttribute('id', 'gradient-background5');
    var stop1 = document.createElementNS("http://www.w3.org/2000/svg", "stop");
...
Dial.prototype.createSlice = function() {
    ...
    slice.setAttribute('stroke', 'url(#gradient5)');
...
Dial.prototype.createOverlay = function() {
    ...
    circle.setAttribute('fill', 'url(#gradient-background5)');
