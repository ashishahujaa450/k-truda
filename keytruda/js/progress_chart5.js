...
Dial.prototype.createDefs = function() {
    ...
    linearGradient.setAttribute('id', 'gradient4');
    ...
    linearGradientBackground.setAttribute('id', 'gradient-background4');
    var stop1 = document.createElementNS("http://www.w3.org/2000/svg", "stop");
...
Dial.prototype.createSlice = function() {
    ...
    slice.setAttribute('stroke', 'url(#gradient4)');
...
Dial.prototype.createOverlay = function() {
    ...
    circle.setAttribute('fill', 'url(#gradient-background4)');
